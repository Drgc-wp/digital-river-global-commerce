...
var CheckoutModule = function ($) {
  ...
  var updateSummaryLabels = function updateSummaryLabels() {
    var taxSuffixLabel = checkout_utils.isTaxInclusive() ? drgc_params.forceExclTax === 'true' ? ' ' + drgc_params.translations.excl_vat_label : ' ' + drgc_params.translations.incl_vat_label : '';

    if ($('.dr-checkout__payment').hasClass('active') || $('.dr-checkout__confirmation').hasClass('active')) {
      $('.dr-summary__tax .item-label').text(checkout_utils.shouldDisplayVat() ? drgc_params.translations.vat_label : drgc_params.translations.tax_label);
      ...
      $('.dr-summary__tax .item-label').text(checkout_utils.shouldDisplayVat() ? drgc_params.translations.estimated_vat_label : drgc_params.translations.estimated_tax_label);
