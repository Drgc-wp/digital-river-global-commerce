...
jQuery(document).ready(function ($) {
  ...
  $('body').on('click', '.dr-buy-candyRack', function (e) {
    ...
    var productId = $this.attr('data-parent-product-id');
